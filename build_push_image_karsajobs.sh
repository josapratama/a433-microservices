...
# Deskripsi: Script untuk build dan push Docker image backend
#            Karsa Jobs ke GitHub Container Registry (GHCR).
# Penggunaan:
#   1. Set environment variable GITHUB_TOKEN sebelum menjalankan:
#      export GITHUB_TOKEN=<personal_access_token_anda>
#   2. Jalankan script: bash build_push_image_karsajobs.sh
# =============================================================

# Variabel konfigurasi
GITHUB_USERNAME="josapratama"
IMAGE_NAME="ghcr.io/${GITHUB_USERNAME}/karsajobs"
IMAGE_TAG="latest"
